...
string SelectDemon()
{
	...
	{
		sTag="ps_summon_hellfire1";
	}	
	if (5 <= nRandom && nRandom < 25)
	{
		sTag = "c_summon_baatezu_mephasm";
	}	
	if (25 <= nRandom && nRandom < 35)
	{
		sTag = "ps_summon_hellfire2";
	}		
	if (35 <= nRandom && nRandom < 50)
	{
		sTag = "c_summon_baatezu_horneddevil";
	}
	if (50 <= nRandom && nRandom < 60)
	{
		sTag = "ps_summon_hellfire3";
	}
