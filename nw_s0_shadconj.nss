        ...
        case 3:
			{
	            ...
	            effect eSummon = EffectSummonCreature("ps_shadow_conjuration", VFX_HIT_SPELL_SUMMON_CREATURE);
	            ApplyEffectAtLocation(DURATION_TYPE_TEMPORARY, eSummon, GetSpellTargetLocation(), fSummonDuration);
