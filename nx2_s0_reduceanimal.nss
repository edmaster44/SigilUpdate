...
//:: RPGplayer1 02/23/09 - RemoveEffectsFromSpell() synched with PS_ApplyEffectToObject()
...
void main()
{
	...
	DelayCommand(1.5, PS_ApplyEffectToObject(nDurType, eLink, oTarget, fDuration));
