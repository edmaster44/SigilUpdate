...
const string ESSENCE_TYPE1_CHAOS		= "cft_ess_chaos";
const string ESSENCE_TYPE1_LAW			= "cft_ess_law";
const string ESSENCE_TYPE1_GOOD			= "cft_ess_good";
const string ESSENCE_TYPE1_EVIL			= "cft_ess_evil";
const string ESSENCE_TYPE1_LIFE			= "cft_ess_life";
const string ESSENCE_TYPE1_DEATH		= "cft_ess_death";
...
const string ELEMENT_CHAOS          	= "chaos";
const string ELEMENT_LAW	          	= "law";
const string ELEMENT_EVIL	          	= "evil";
const string ELEMENT_GOOD	          	= "good";
...
int GetIsEssenceGroup1(object oTarget)
{
	...
	if (IsPrefixMatch(sTag, ESSENCE_TYPE1_FIRE) ||
		...
		IsPrefixMatch(sTag, ESSENCE_TYPE1_CHAOS) ||
		IsPrefixMatch(sTag, ESSENCE_TYPE1_LAW) ||
		IsPrefixMatch(sTag, ESSENCE_TYPE1_EVIL) ||
		IsPrefixMatch(sTag, ESSENCE_TYPE1_GOOD) ||
		IsPrefixMatch(sTag, ESSENCE_TYPE1_LIFE) ||
		IsPrefixMatch(sTag, ESSENCE_TYPE1_DEATH))
       	return (TRUE);
